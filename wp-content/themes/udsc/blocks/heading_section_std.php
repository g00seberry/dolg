<?php
/**
 * Heading Section Standard Block Template
 * Hero Section для стандартных страниц
 */

// Получаем данные блока (если используется ACF или аналогичные поля)
$heading = get_field('heading') ?: 'Стоимость услуг банкротства';
$description = get_field('description') ?: 'Фиксированная стоимость без скрытых платежей. Оплата по этапам. Первая консультация всегда бесплатная.';
$badge_text = get_field('badge_text') ?: 'Прозрачные цены';
?>
