...
/* harmony export */   cleanupAccordions: () => (/* binding */ cleanupAccordions),
/* harmony export */   cleanupDropdowns: () => (/* binding */ cleanupDropdowns),
/* harmony export */   cleanupGallery: () => (/* binding */ cleanupGallery),
/* harmony export */   cleanupModals: () => (/* binding */ cleanupModals),
/* harmony export */   cleanupPopovers: () => (/* binding */ cleanupPopovers),
/* harmony export */   cleanupSteppers: () => (/* binding */ cleanupSteppers),
/* harmony export */   cleanupTabs: () => (/* binding */ cleanupTabs),
/* harmony export */   cleanupTooltips: () => (/* binding */ cleanupTooltips),
/* harmony export */   "default": () => (/* binding */ index),
/* harmony export */   initAccordion: () => (/* binding */ initAccordion),
/* harmony export */   initAlert: () => (/* binding */ initAlert),
/* harmony export */   initCollapse: () => (/* binding */ initCollapse),
/* harmony export */   initDropdowns: () => (/* binding */ initDropdowns),
/* harmony export */   initGallery: () => (/* binding */ initGallery),
/* harmony export */   initMaterialTailwind: () => (/* binding */ initMaterialTailwind),
/* harmony export */   initModal: () => (/* binding */ initModal),
/* harmony export */   initPopovers: () => (/* binding */ initPopovers),
/* harmony export */   initStepper: () => (/* binding */ initStepper),
/* harmony export */   initTabs: () => (/* binding */ initTabs),
/* harmony export */   initTooltips: () => (/* binding */ initTooltips),
/* harmony export */   toggleAccordionById: () => (/* binding */ toggleAccordionById)
/* harmony export */ });
 ...
 * @since 1.0.0
 */
var ConsultationFormHandler = /*#__PURE__*/function () {
  function ConsultationFormHandler(formId) {
    _classCallCheck(this, ConsultationFormHandler);
    this.form = document.getElementById(formId);
    if (!this.form) return;
    this.init();
  }
  return _createClass(ConsultationFormHandler, [{
    key: "init",
    value: function init() {
      var _this = this;
    ...
    value: function handleSubmit(e) {
      ...
      setTimeout(function () {
        _this2.showSuccess();
        _this2.resetForm(submitBtn, originalText);
      }, 1500);
    }
  }, {
    key: "showSuccess",
    ...
    key: "resetForm",
    value: function resetForm(submitBtn, originalText) {
...
document.addEventListener("DOMContentLoaded", function () {
  var consultationForms = document.querySelectorAll('form[id^="consultation-modal-form"]');
...
/*!**********************!*\
  ...
  \**********************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _material_tailwind_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @material-tailwind/html */ "./node_modules/@material-tailwind/html/dist/material-tailwind.esm.js");
/* harmony import */ var _js_consultation_form_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./js/consultation-form.js */ "./src/js/consultation-form.js");
/* harmony import */ var _js_consultation_form_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_js_consultation_form_js__WEBPACK_IMPORTED_MODULE_1__);



// Initialize all components in your app
(0,_material_tailwind_html__WEBPACK_IMPORTED_MODULE_0__.initMaterialTailwind)();
