			...
			<div class="container">
				<div class="flex items-center justify-between text-sm text-muted-foreground">
					<div class="flex items-center gap-6">
						<a href="tel:<?php echo esc_attr(udsc_get_contact_phone()); ?>" class="flex items-center gap-2 hover:text-primary transition-colors">
							<svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
								<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path>
							</svg>
							<span><?php echo esc_html(udsc_get_contact_phone()); ?></span>
						</a>
						<a href="mailto:<?php echo esc_attr(udsc_get_contact_email()); ?>" class="flex items-center gap-2 hover:text-primary transition-colors">
							<svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
					...
					<div class="hidden md:flex items-center gap-4">
						...
						<div class="flex items-center gap-2 ml-4">
							<a href="<?php echo esc_url(udsc_get_contact_vk()); ?>" target="_blank" rel="noopener noreferrer" class="hover:text-primary transition-colors">
							...
							<a href="<?php echo esc_url(udsc_get_contact_telegram()); ?>" target="_blank" rel="noopener noreferrer" class="hover:text-primary transition-colors">
